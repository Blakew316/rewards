...
window.WPI = (function () {
  ...
  const catalog = [
    ...
    { id: "gc-starbucks",  cat: "gift", brand: "Starbucks",   name: "$25 Starbucks Gift Card",          desc: "Delivered by email within one business day.", points: 3000 , img: "https://tuzo-django-store.s3.amazonaws.com/Starbucks.png" },
    { id: "gc-doordash",   cat: "gift", brand: "DoorDash",    name: "$50 DoorDash Gift Card",           desc: "Delivered by email within one business day.", points: 6000 , img: "https://tuzo-django-store.s3.amazonaws.com/DoorDash.png" },

    // Merchandise
    { id: "m-ipad",     cat: "merch", brand: "Apple",     name: "iPad (11-inch, Wi-Fi, 128GB)",         desc: "Ships factory sealed with full warranty.", points: 41280 , img: "https://tuzo-django-store.s3.amazonaws.com/rewards_images/xWiStCkryEkpDqQiSb45_main_image_IQn71DV.jpg", imgAlt: "https://wpirewards.com/_next/image/?url=https%3A%2F%2Ftuzo-django-store.s3.amazonaws.com%2Frewards_images%2FxWiStCkryEkpDqQiSb45_main_image_IQn71DV.jpg&w=640&q=75" },
